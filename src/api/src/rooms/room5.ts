...
import { FirstPot } from "../characters/pots/FirstPot";
...
export class Room5 extends Room {
    ...
    public objects(): GameObject[] {
        ...
        // }
            return [this, new WitchCharacter(), new FirstPot()];
        
    }

    public examine(): ActionResult | undefined {
        return new TextActionResult([
            "Upon entering the room, you are met with an eerie stillness broken only by the crackling of fire and the witch's cackling. Large cauldrons bubble in the corners, emitting strange odors. With each step, the room pulses with unsettling energy, but you steel yourself for the challenges ahead.",
        ]);
    }
