...
export class Room2 extends Room {
    ...
    public actions(): Action[] {
        return [new ExamineAction(), new PickupAction(), new TalkAction(), new CustomAction("room3","Room 3",false)];
    }
    public objects(): GameObject[] {
        ...
        objects.push(new KeyItem2,new KeyItem3, new GhostCharacter(),...inventoryItems);
        return objects;
    }
